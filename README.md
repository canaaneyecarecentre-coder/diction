...
3.  **Settings**:
    ...
    *   Toggle "Read Punctuation" if you want the app to say "comma", "period", etc.
4.  **Start**: Click "START DICTATION ▶".
5.  **Practice**:
    *   Listen to the word.
    *   Write it down.
...
Simply clone the repository and open `index.html` in any modern web browser. No build step required!

```bash
git clone https://github.com/v2ryan/gemdictation.git
cd gemdictation
...
This project is open source. Feel free to modify and use it for your own learning!
